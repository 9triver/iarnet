...
@function(
    ...
    dependency=["-i https://pypi.mirrors.ustc.edu.cn/simple torch==2.8.0", "-i https://pypi.mirrors.ustc.edu.cn/simple datasets", "-i https://pypi.mirrors.ustc.edu.cn/simple pandas", "-i https://pypi.mirrors.ustc.edu.cn/simple modelscope", "-i https://pypi.mirrors.ustc.edu.cn/simple transformers"],
    provider="actor",
    name="read_data",
    venv="test2",
    cpu=500,
...
@function(
    wrapper=ActorFunction,
    dependency=["-i https://pypi.mirrors.ustc.edu.cn/simple datasets", "-i https://pypi.mirrors.ustc.edu.cn/simple modelscope", "-i https://pypi.mirrors.ustc.edu.cn/simple torch==2.8.0", "-i https://pypi.mirrors.ustc.edu.cn/simple peft", "-i https://pypi.mirrors.ustc.edu.cn/simple transformers", "-i https://pypi.mirrors.ustc.edu.cn/simple bitsandbytes"],
    provider="actor",
    name="train",
    venv="test2",
    cpu=2000,
