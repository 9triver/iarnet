...
class SubmitLogRequest(_message.Message):
    __slots__ = ("application_id", "component_id", "entry")
    ...
    def __init__(self, application_id: _Optional[str] = ..., component_id: _Optional[str] = ..., entry: _Optional[_Union[_logger_pb2.LogEntry, _Mapping]] = ...) -> None: ...
...
class BatchSubmitLogRequest(_message.Message):
    __slots__ = ("application_id", "component_id", "entries")
    APPLICATION_ID_FIELD_NUMBER: _ClassVar[int]
    COMPONENT_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, application_id: _Optional[str] = ..., component_id: _Optional[str] = ..., entries: _Optional[_Iterable[_Union[_logger_pb2.LogEntry, _Mapping]]] = ...) -> None: ...
...
class LogStreamMessage(_message.Message):
    __slots__ = ("application_id", "component_id", "entry", "control")
    APPLICATION_ID_FIELD_NUMBER: _ClassVar[int]
    COMPONENT_ID_FIELD_NUMBER: _ClassVar[int]
    ENTRY_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, application_id: _Optional[str] = ..., component_id: _Optional[str] = ..., entry: _Optional[_Union[_logger_pb2.LogEntry, _Mapping]] = ..., control: _Optional[_Union[_logger_pb2.StreamControl, _Mapping]] = ...) -> None: ...
