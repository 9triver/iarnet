...
const (
	LoggerService_StreamLogs_FullMethodName = "/application.logger.LoggerService/StreamLogs"
)
...
var LoggerService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "application.logger.LoggerService",
	...
	Metadata: "application/logger/logger.proto",
}
